...
//测试virt fb的性能
    ...
    printf ("Will draw 3 rectangles on the screen,\n"
        ...
        drawRect (20, 20, 40, 40, 0xff00ff00);
        drawRect (0, 50, 40, 40, 0xff0000ff);
        drawRect (80, 100, 100, 100, 0xff00ff00);
        drawRect (200, 200, 200, 200, 0xff00ff00);
        drawRect (400, 400, 400, 400, 0xff0000ff);
        drawRect (350, 50, 40, 40, 0xff0000ff);
        drawRect (90, 200, 300, 300, 0xff0000ff);
